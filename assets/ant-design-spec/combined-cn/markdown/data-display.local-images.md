...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-01-PetAXSByOolFbtmLazQz.png">
</ImagePreview>
...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-02-ypeOSafZJYqVJUHcJeef.png">
</ImagePreview>
...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-03-xtIGZmqUHAovPPKjwyVT.png" description="如页面内容加载过慢时，可采用『预加载』或『分步获取』的方式来缓解用户在等待时间中的焦虑感。">
</ImagePreview>
...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-04-FaAbGkTwlhykSDSBqWbW.png">
</ImagePreview>
...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-05-QZyxnLWUkbIuTqGYxTQs.png">
</ImagePreview>
...
<ImagePreview>
  <img class="preview-img no-padding" src="assets/data-display-06-WmQeylAyWUNKmQIyoQGH.png">
</ImagePreview>
