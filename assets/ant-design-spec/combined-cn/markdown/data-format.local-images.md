...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-01-A-vjAcTqS6VKoAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" src="assets/data-format-02-A-3CXaSK6NcrwAAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-03-A-5ymtS5WU83EAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" description="单位统一放在表头上，表格里不带单位，金额默认右对齐" src="assets/data-format-04-A-qjzFQL3CqiQAAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-05-A-FGtoQIKHySkAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" description="金额数字到「元」为止的，在「元」之后，应写「整」字，在「角」之后可以不写「整」字。金额数字有「分」的，「分」后面不写「整」字。" src="assets/data-format-06-A-adz2QIF8umQAAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-07-A-dHYhQ4iqnJkAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img good" alt="推荐示例" src="assets/data-format-08-A-T6hbQJdz5usAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" description="“千”不能以单位的形式展示。" src="assets/data-format-09-A-iuEARoq_-o0AAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-10-A-NJs8QYejQyEAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" src="assets/data-format-11-A-JvI4T5SXvIYAAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img good" alt="推荐示例" src="assets/data-format-12-A-o0duS6P8WUEAAAAAAAAAAABkARQnAQ.png">
<img class="preview-img bad" alt="不推荐示例" src="assets/data-format-13-A-ssPWRaVkIy8AAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
...
<ImagePreview>
<img class="preview-img" src="assets/data-format-14-A-E6pGTJYEh-gAAAAAAAAAAABkARQnAQ.png">
</ImagePreview>
数据加载用「骨架屏」表示。
